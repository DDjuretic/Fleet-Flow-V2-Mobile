...
The project is a monorepo with a clear separation between the mobile app, web app, and shared configurations. The root directory is the single source of truth for dependencies and project-wide scripts.
