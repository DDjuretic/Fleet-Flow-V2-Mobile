...
export default function SystemLogsScreen({ navigation }: SystemLogsScreenProps) {
        ...
        {metadata && Object.keys(metadata).length > 0 && (
          <View style={styles.metadataContainer}>
            ...
            {metadata.vehicle_tank_capacity && (
              <Text style={[styles.metadataText, { color: screenColors.textSecondary }]}>
                🛢️ Tank: {metadata.vehicle_tank_capacity}L
              </Text>
            )}
          </View>
        )}
    ...
    >
      <SafeAreaView style={[styles.modalContainer, { backgroundColor: screenColors.background }]}>
        <View style={[styles.modalHeader, { backgroundColor: screenColors.card, borderBottomColor: screenColors.border }]}>
          <Text style={[styles.modalTitle, { color: screenColors.text }]}>Filter Logs</Text>
        ...
        <ScrollView style={styles.filterContent}>
          ...
          {/* Log Type Filter */}
          <View style={styles.filterSection}>
            <Text style={[styles.filterSectionTitle, { color: screenColors.text }]}>Log Type</Text>
  ...
  const renderResolutionModal = () => (
    ...
    >
      <SafeAreaView style={[styles.modalContainer, { backgroundColor: screenColors.background }]}>
        <View style={[styles.modalHeader, { backgroundColor: screenColors.card, borderBottomColor: screenColors.border }]}>
          <Text style={[styles.modalTitle, { color: screenColors.text }]}>Resolve Log</Text>
        ...
        <View style={styles.resolutionContent}>
          ...
          <TextInput
            ...
            onChangeText={setResolutionNotes}
                            placeholder={t('resolution_notes_placeholder', 'Add notes about how this issue was resolved...')}
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: screenColors.background }]}>
      ...
      <View style={[styles.header, { backgroundColor: screenColors.card, borderBottomColor: screenColors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: screenColors.text }]}>System Logs</Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            <Ionicons name="document-text-outline" size={64} color={screenColors.textSecondary} />
            ...
            <Text style={[styles.emptyStateSubtext, { color: screenColors.textSecondary }]}>
              System logs will appear here when unusual activities are detected
            </Text>
          </View>
        }
      />
