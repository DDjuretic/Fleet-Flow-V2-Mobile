...
('d0000001-0000-4000-8000-000000000001', (SELECT company_id FROM companies LIMIT 1), 'Management'),
('d0000001-0000-4000-8000-000000000002', (SELECT company_id FROM companies LIMIT 1), 'Logistics'),
('d0000001-0000-4000-8000-000000000003', (SELECT company_id FROM companies LIMIT 1), 'IT Support'); 